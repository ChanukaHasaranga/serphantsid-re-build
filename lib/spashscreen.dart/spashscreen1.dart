      ...
      body: SafeArea(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.fromLTRB(34, 54, 34, 0),
                child: Text("!dentify various kinds of snakes around you.",style: TextStyle(fontSize: 32,fontWeight: FontWeight.normal,color: Colors.white,height:1.2,fontFamily: "Poppins"),textAlign: TextAlign.left,),
              ),
              Padding(
                padding: const EdgeInsets.fromLTRB(267, 10, 0, 0),
